...
Home.getInitialProps = async ctx => {
  ...
  const size = 6; //fetch from server
  ...
  const response = await axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(url, payload); //return response as object
  // note:
  //return {hello:'world'}
...
module.exports = __webpack_require__(/*! /media/ashish/workbook/Ginisha-Store/pages/index.js */"./pages/index.js");
