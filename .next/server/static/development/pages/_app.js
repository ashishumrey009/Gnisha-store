...
function Header({
  ...
  const router = Object(next_router__WEBPACK_IMPORTED_MODULE_3__["useRouter"])(); // router.pathname
  // const user =false;
  ...
  }), "Ginish Dream Place")), __jsx(next_link__WEBPACK_IMPORTED_MODULE_2___default.a, {
    href: "/cart"
  }, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_1__["Menu"].Item, {
    header: true,
...
function Layout({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_1___default.a, null, __jsx(_HeadContent__WEBPACK_IMPORTED_MODULE_4__["default"], null), __jsx("link", {
    rel: "stylesheet",
    type: "text/css",
  ...
  }), __jsx("title", null, "Ginisha DreamPlace")), __jsx(_Header__WEBPACK_IMPORTED_MODULE_3__["default"], {
    user: user
...
class MyApp extends next_app__WEBPACK_IMPORTED_MODULE_2___default.a {
  constructor(...args) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "syncLogout", event => {
      if (event.key === "logout") {
  ...
  static async getInitialProps({
    ...
    const {
      token
    } = Object(nookies__WEBPACK_IMPORTED_MODULE_4__["parseCookies"])(ctx); // console.log('token is',token)
    ...
    if (!token) {
      ...
      try {
        ...
        const response = await axios__WEBPACK_IMPORTED_MODULE_7___default.a.get(url, payload); // console.log('respose form api',response.data)
        ...
        console.error("Error getting user", error); //throw invalid token

        Object(nookies__WEBPACK_IMPORTED_MODULE_4__["destroyCookie"])(ctx, "token");
        Object(_utils_auth__WEBPACK_IMPORTED_MODULE_5__["redirectUser"])(ctx, "/login");
      }
    }
  ...
  render() {
    ...
    return __jsx(_components_App_Layout__WEBPACK_IMPORTED_MODULE_3__["default"], pageProps, __jsx(Component, pageProps));
  }
...
function handleLogin(token) {
  ...
  next_router__WEBPACK_IMPORTED_MODULE_3___default.a.push("/account");
}
